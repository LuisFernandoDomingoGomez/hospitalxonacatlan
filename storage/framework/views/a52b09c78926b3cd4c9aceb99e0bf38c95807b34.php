<?php $__env->startSection('contenido'); ?>
    ...
    <section class="content-header">
     ...
     <ol class="breadcrumb">
        ...
        <li><a href="<?php echo e('usuarios2'); ?>">Usuarios</a></li>
...
<div class="container-fluid">
 ...
 <form class="form-horizontal m-t-30" action = "<?php echo e(route('modificausuario2')); ?>" method = "POST" enctype='multipart/form-data'>
