    ...
    <tr>
        ...
        <tr>
            ...
            <td colspan="2" style="border: none;">
                ...
                <input type="text" class="form-control" name="" id="" value="" placeholder="Secundario" readonly>
            </td>
        ...
        <tr>
            ...
            <td style="border: none;" id="motivo">
                ...
                <input type="text" class="form-control" name="Cantidad_surtida" id="Cantidad_surtida" value="<?php echo e($e->Cantidad_surtida); ?>" readonly><br>
				<center>
        ...
        <tr>
            ...
            <td style="border: none;">
                ...
                <input type="text" class="form-control" name="" id="" value="" placeholder="Primario">
        ...
        <tr>
            <td style="border: none;">
				...
				<input type="text" class="form-control" size="" name="Id_trabajador" id="" value="<?php echo e($e->id_trabajador); ?>" hidden>
                ...
                <input type="text" style="visibility:hidden;" class="form-control" size="4" name="nombre_tra" id="" value="<?php echo e($e->nombre_tra); ?>" placeholder="Nombre medico" readonly>
            </td>
            ...
            <td style="border: none;" id="motivo2">
                <font size=1>CANTIDAD SURTIDA (LETRA)</font><br>
                <input type="text" class="form-control" name="Cantidad_surtida2" id="" value="<?php echo e($e->Cantidad_surtida2); ?>" readonly>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="border: none;">
                <font size=1>CANTIDAD SURTIDA (LETRA)</font><br>
                <input type="text" class="form-control" name="Cantidad_surtida3" id="" value="<?php echo e($e->Cantidad_surtida3); ?>" readonly>
            </td>
        </tr>
