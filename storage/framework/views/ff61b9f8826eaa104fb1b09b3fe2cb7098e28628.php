   ...
   <table style="border-collapse: collapse" WIDTH="1000" border="1" cellspacing="0" cellpadding="10">
    ...
    <tr>
        ...
        <tr>
            ...
            <td colspan="2" style="border: none;">
                <font size=1>CLAVE DEL DIAGN&Oacute;STICO(CIE-10)</font><br><br><br>
        ...
        <tr>
            <td style="border: none;">
                ...
                <input type="text" class="form-control" name="Edad" id="" value="" placeholder="Edad" onkeypress="return solonumeros(event)">
            </td>
            ...
            <td style="border: none;">
                ...
                <input type="text" class="form-control" name="Clave_Diagnostico2" id="Clave_Diagnostico2" value="" placeholder="Primario">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="border: none;">
               <font size=1>CLAVE DEL DIAGNOSTICO(CIE-10)</font><br><br>
               <input type="text" class="form-control" name="Clave_Diagnostico3" id="Clave_Diagnostico3" value="" placeholder="Primario">
            </td>
        </tr>
