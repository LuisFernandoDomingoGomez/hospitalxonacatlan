...
<?php $__env->startSection('receta'); ?>
 <div class="page-breadcrumb">
            ...
            <div class="col-5 align-self-center">
                ...
                <center>
                   <img src="<?php echo e(asset('laravel/img/paciente.png')); ?>" width="110" height="110">
                    <br><br>

             <a type="button"  href="<?php echo e('altapac'); ?>" class="btn btn-primary">Alta Nuevo Paciente</a>
              <center>
            ...
            $(document).ready(function() {
                $('#users').DataTable({
                    "serverSide": true,
                     processing: true,
                     bAutoWidth: false,
                    "ajax": "<?php echo e(url('api/pacientes')); ?>",
                    "columns": [
                        {data: 'id_paciente'},
                        {data: 'nom_paciente'},
                        {data: 'ap_paciente'},
                        {data: 'am_paciente'},
                        {data: 'afiliacion_seguro'},
                        {data: 'num_afiliacion'},
                        {data: 'btn'},
                    ],
                    "language": {
