...
<?php $__env->startSection('receta'); ?>
           <div class="page-breadcrumb">
            ...
            <div class="col-5 align-self-center">
                ...
                <center>
                    <img src="<?php echo e(asset('laravel/img/icons8-libro-de-salud-96.png')); ?>" width="80" height="80">
                    <br><br>

             <a type="button"  href="<?php echo e('altaeg'); ?>" class="btn btn-primary">Crear Estudio de Gabinete</a>
              <center>
            ...
            $(document).ready(function() {
                $('#users').DataTable({
                    "serverSide": true,
                     processing: true,
                     bAutoWidth: false,
                    "ajax": "<?php echo e(url('api/estudiogabinete')); ?>",
                    "columns": [
