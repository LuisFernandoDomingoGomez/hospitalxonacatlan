...
<tr>
    <td style="border: none;">
       ...
       <input type="text" class="form-control" size=15 name="Id_expediente" id="" value="<?php echo e($r->expediente); ?>" placeholder="Numero expediente" readonly>
       <input type="text" class="form-control" size=15 name="Id_expediente" id="" value="<?php echo e($r->id_expediente); ?>" placeholder="Numero expediente" readonly  style="visibility:hidden;">
