...
<div class="container-fluid">
 ...
 <form class="form-horizontal m-t-30" action = "<?php echo e(route('modificatrabajador')); ?>" method = "POST" enctype='multipart/form-data'>
<?php echo e(csrf_field()); ?>

<div class="form-group">
<label>Id Trabajador :</label>
<input type="text" class="form-control" name = 'id_trabajador' value="<?php echo e($trabajadores->id_trabajador); ?>" readonly ='readonly'>
</div>
     <div class="form-group">
                                    <label>Nombre(S): </label>
                                    <input type="text" class="form-control" name = 'nombre_tra' value="<?php echo e($trabajadores->nombre_tra); ?>" required placeholder="Ej. Pedro Juan">
...
<?php endif; ?>                                
	 ...
	 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'ap_tra' value="<?php echo e($trabajadores->ap_tra); ?>" required placeholder="Ej. Lopéz">
...
<?php endif; ?>                                
 ...
 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'am_tra' value="<?php echo e($trabajadores->am_tra); ?>" required placeholder="Ej. Herrera">
...
<?php endif; ?>                                
 ...
 <div class="custom-control custom-radio">
                                            <input type="radio" id="customRadio1" name="sexo" value='M' class="custom-control-input" <?php if($trabajadores->sexo=='M'): ?> echo checked="checked"; <?php endif; ?> >
                                            <label class="custom-control-label" for="customRadio1">Masculino</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="customRadio2" name="sexo" value='F'class="custom-control-input" <?php if($trabajadores->sexo=='F'): ?> echo checked="checked"; <?php endif; ?>>
	...
	<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'cedula_profesional'  value="<?php echo e($trabajadores->cedula_profesional); ?>" required placeholder="Ej.12345678">
...
<?php endif; ?>                                
	...
	<div class="form-group">
                                    <label>Turno: </label>
                                    <input type="text" class="form-control" name = 'turno' value="<?php echo e($trabajadores->turno); ?>" required placeholder="Ej.Nocturno A">
...
<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'dias_laborales' value="<?php echo e($trabajadores->dias_laborales); ?>" required placeholder="1-7">
...
<div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name = 'hr_entrada' value="<?php echo e($trabajadores->hr_entrada); ?>" required >
...
<div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name = 'hr_salida' value="<?php echo e($trabajadores->hr_salida); ?>" required >
...
<?php endif; ?>                                
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'especialidad' value="<?php echo e($trabajadores->especialidad); ?>" required placeholder="Ing./Lic. En:">
...
<?php endif; ?>                                
	...
	<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'escolaridad' value="<?php echo e($trabajadores->escolaridad); ?>" required placeholder="Primaria/Secundaria/Preparatoria/...:">
...
<?php endif; ?>                                
	...
	<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name ="telefono" value="<?php echo e($trabajadores->telefono); ?>" required placeholder="Ej.7221234567">
...
<input type="email" id="example-email" name="email" class="form-control" value="<?php echo e($trabajadores->email); ?>" placeholder="tucorreo@gmail.com" required>
...
<?php endif; ?>
	...
	<div class="form-group">
                                    <label>RFC: </label>
                                    <input type="text" class="form-control" name = 'rfc' value="<?php echo e($trabajadores->rfc); ?>" required placeholder="Ej.ABCD123456EFG">
