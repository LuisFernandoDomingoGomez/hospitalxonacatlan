...
<head>
  ...
  <link rel="icon" type="image/png" href="<?php echo e(asset('login/images/icons/favicon3.ico')); ?>"/>
   <title><?php echo e(Session::get('nom_system')); ?> - <?php echo e(Session::get('sesiontipo')); ?></title>
                    ...
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                          ...
                          <!-- /////////////////////////PASAR CODIGO////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////// -->
                        <img src="<?php echo e(asset('../storage/app/'.Session::get('sesionfoto'))); ?>" class="img-circle" alt="User Image">
...
<?php 
   ...
   ?>
              ...
              <img src="<?php echo e(asset('../storage/app/'. $mostrar['fotoperfil']  )); ?>" class="user-image" alt="User Image">
...
<?php 
   ...
   ?>
                ...
                <img src="<?php echo e(asset('../storage/app/'. $mostrar['fotoperfil']  )); ?>" class="img-circle" alt="User Image">
  ...
  <!-- /////////////////////////PASAR CODIGO////////////////////////////////////////////////////
        ///////////////////////////////////////////////////////////////////////////// -->
                ...
                <p>
                  <?php echo e(Session::get('sesionname')); ?><br> <?php echo e(Session::get('nom_system')); ?> - <?php echo e(Session::get('sesiontipo')); ?>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo e(route('password')); ?>" class="btn btn-default btn-flat">Cambiar contraseña</a>
                  <form id="logout-form" action="<?php echo e(route('index')); ?>" method="get" style="display: none;">
...
<?php 
   ...
   ?>
          <img src="<?php echo e(asset('../storage/app/'. $mostrar['fotoperfil'])); ?>" width="100" height="100" >
   ...
   ?>
        ...
        <div class="pull-left info">
         ...
         <!-- Status -->
         <p><a href="#"><i class="fa fa-circle text-success"></i>Activo - <?php echo e(Session::get('sesiontipo')); ?></a></p> 
        </div>
      </div><br>
...
<li hidden><a href="<?php echo e('tb'); ?>" >tabla  </a></li>
<li hidden><a href="<?php echo e('tb1'); ?>" >tabla1</a></li>
<li><a href="<?php echo e('publicidad'); ?>"><img src="<?php echo e(asset('laravel/img/banner_publicidad.png')); ?>" width="20" height="20"> Publicidad</a></li>
          </ul>
       </li>
    ...
    <li class="treeview"><a href="#"><img src="<?php echo e(asset('laravel/img/ambulancia.png')); ?>" width="20" height="20"><span> Urgencias</span>
         ...
         <!-- //////// HOJA DE INDICACIONES MEDICAS -->
           ...
           <li><a href="<?php echo e('indicacionesmedicas'); ?>"><img src="<?php echo e(asset('laravel/img/imedicas.jpg')); ?>" width="20" height="20"> Indicaciones Médicas</a></li>
            ...
            <a href="#">
              <img src="<?php echo e(asset('laravel/img/historial-medico1.png')); ?>" width="20" height="20"> Receta Medica
                ...
                <ul class="treeview-menu">
                  ...
                  <li>
                    <a href="<?php echo e('recetapoblacion'); ?>">
                      <img src="<?php echo e(asset('laravel/img/historial-medico1.png')); ?>" width="20" height="20">Sin Expediente.
                    </a>
                  </li>
                </ul>
          </li>
            
            <li><a href="<?php echo e(route('principalh')); ?>"><img src="<?php echo e(asset('laravel/img/libro.png')); ?>" width="20" height="20">Historia Clinica General</a></li>
            <li><a href="<?php echo e(route('principaln')); ?>"><img src="<?php echo e(asset('laravel/img/resultados-medicos.png')); ?>" width="20" height="20">Notas de Evolucion</a></li>
            <li><a href="<?php echo e(route('principaleg')); ?>"><img src="<?php echo e(asset('laravel/img/electrocardiograma.png')); ?>" width="20" height="20">Estudio de Gabinete</a></li>
            <li><a href="<?php echo e(route('principalcu')); ?>"><img src="<?php echo e(asset('laravel/img/icons8-libro-de-salud-96.png')); ?>" width="20" height="20">Consulta de Urgencia</a></li>
            <li><a href="<?php echo e(route('principalci')); ?>"><img src="<?php echo e(asset('laravel/img/certificado-medico.png')); ?>" width="20" height="20">Consentimiento Informado </a></li>
            <li><a href="<?php echo e(route('principalht')); ?>"><img src="<?php echo e(asset('laravel/img/icons8-libro-de-salud-64.png')); ?>" width="20" height="20">Hoja de Triage</a></li>

            <li><a href="<?php echo e(route('principalht')); ?>"><img src="<?php echo e(asset('laravel/img/icons8-libro-de-salud-64.png')); ?>" width="20" height="20">Hoja de Triage</a></li>
            <li><a href="<?php echo e(route('principalto')); ?>"><img src="<?php echo e(asset('laravel/img/icons8-plan-de-tratamiento-96.png')); ?>" width="20" height="20">Triage obstretico <br> 217820000-203-09</a></li>
          </ul>
      
            
              <li><a href="<?php echo e(URL::action('cexpedientes@principalexs')); ?>"><img src="<?php echo e(asset('laravel/img/icons8-carpeta-de-doctores-64.png')); ?>" width="20" height="20">Expedientes digitales</a></li>
...
<?php if(Session::get('sesiontipo')=="AdministradorArchivo"): ?>


<li class="treeview"><a href="#"><img src="<?php echo e(asset('laravel/img/hospital.png')); ?>" width="20" height="20"><span> Sistema de Archivo</span>
         <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
         </span>
       </a>
           <ul class="treeview-menu">
<li><a href="<?php echo e('usuarios2'); ?>"><img src="<?php echo e(asset('laravel/img/usuario.png')); ?>" width="20" height="20"> Usuarios </a></li>
...
<li class="treeview">
            <a href="#">
              <img src="<?php echo e(asset('laravel/img/historial-medico1.png')); ?>" width="20" height="20"> Citas con expedientes
            </a>
                <ul class="treeview-menu">


	              <li><a href="<?php echo e('conexpedientes'); ?>"><img src="<?php echo e(asset('laravel/img/historial-medico1.png')); ?>" width="20" height="20">Mis citas generales</a></li>


	              <li><a href="<?php echo e('conexpedientes2'); ?>"><img src="<?php echo e(asset('laravel/img/historial-medico1.png')); ?>" width="20" height="20">Mis citas de hoy</a></li>
              ...
              <li>
              <p id="li1">
                <img src="<?php echo e(asset('laravel/img/icons8-carpeta-de-doctores-64.png')); ?>" width="20" height="20">  
        ...
        <!--
        <li><a href="<?php echo e('#'); ?>"><img src="<?php echo e(asset('laravel/img/historial-medico1.png')); ?>" width="20" height="20">Sin expedientes</a></li>-->
...
<!--<li class="treeview">
          ...
          <a href="#"><img src="<?php echo e(asset('laravel/img/registro.png')); ?>" width="20" height="20"> <span> Consultas </span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          <ul class="treeview-menu">-->
            ...
            <!--<li><a href="#"><img src="<?php echo e(asset('laravel/img/icons8-carpeta-de-doctores-64.png')); ?>" width="20" height="20">Consultas</a></li>
            <li><a href="#"></a></li>-->
      


<li class="treeview">
          <a href="#"><img src="<?php echo e(asset('laravel/img/registro.png')); ?>" width="20" height="20"> <span> Archivos</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
...
<li class="treeview">
          <a href="#"><img src="<?php echo e(asset('laravel/img/registro.png')); ?>" width="20" height="20"> <span> 
          ...
          <ul class="treeview-menu">
			...
			<li><a href="<?php echo e(URL::action('carchivo@prestamo')); ?>"><img src="<?php echo e(asset('laravel/img/electrocardiograma.png')); ?>" width="20" height="20">Prestamo</a></li>
            <li><a href="#"></a></li>
      </ul>    
...
<li class="treeview">
          ...
          <ul class="treeview-menu">
                ...
                <li><a href="<?php echo e('conexpedientes3'); ?>"><img src="<?php echo e(asset('laravel/img/historial-medico1.png')); ?>" width="20" height="20">Citas generales con exps</a></li>
          </ul>
