...
<center> 
<form class="form-horizontal" action="<?php echo e(route('guardarm')); ?>" method='POST'>
...
<tr>
    ...
    <td colspan="" style="border: none;">
        <font size=1>NOMBRE Y CLAVE DE LA JURISDICCI&Oacute;N:</font><br><br>
            <input type="text" class="form-control" class="sinborde" name="" id="" value="<?php echo e($t->nom_jurisdiccion); ?>" placeholder="Nombre" readonly>
        <input type="text" class="form-control" class="sinborde" size=3 name="" id="" value="<?php echo e($t->jurisdiccion); ?>" placeholder="Clave" readonly>
    </td>
...
<td style="border: none;">
    ...
    <font size=1>
        ...
        &nbsp;&nbsp;<input type="radio" id="con_ext" name="Area"  value="1">&nbsp;CONSULTA EXTERNA &nbsp;
                    <input type="radio" id="urgencias" name="Area" value="2">&nbsp;URGENCIAS<br>
        &nbsp;&nbsp;<input type="radio" id="h" name="Area" value="3">&nbsp;HOSPITALIZACI&Oacute;N
    ...
    <td colspan="" style="border: none;">
        ...
        <!-- <select name="Clave_servicio" class="form-control" required="required">
            <option value="Conulta Externa">1001</option>
            <option value="Conulta Externa">100</option>
            <option value="Urgencias">1005</option>
            <option value="Cliente/Proveedor">1006</option>
        </select> -->
        <select name="Nom_servicio">
        ...
        <input type="text" class="form-control" size="20" name="Clave_servicio" id="" value="" placeholder="Clave_servicio" required>
    </td>
...
<tr>
    ...
    <td style="border: none;">
        ...
        <input type="text" class="form-control" size="1" name="Genero" id="" value="<?php echo e($r->sexo); ?>" placeholder="Genero" readonly style="display:none">
