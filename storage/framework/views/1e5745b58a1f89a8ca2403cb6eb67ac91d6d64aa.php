...
<div class="container-fluid">
 ...
 <form class="form-horizontal m-t-30" action = "<?php echo e(route('modificapaciente')); ?>" method = "POST" >
<?php echo e(csrf_field()); ?>

<div class="form-group">
<label>Id Paciente :</label>
<input type="text" class="form-control" name = 'id_paciente' value="<?php echo e($pacientes->id_paciente); ?>" readonly ='readonly'>
</div>
     <div class="form-group">
                                    <label>Nombre(S): </label>
                                    <input type="text" class="form-control" name = 'nom_paciente' value="<?php echo e($pacientes->nom_paciente); ?>" required placeholder="Ej. Pedro Juan">
...
<?php endif; ?>                                
	 ...
	 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'ap_paciente' value="<?php echo e($pacientes->ap_paciente); ?>" required placeholder="Ej. Lopéz">
...
<?php endif; ?>                                
 ...
 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'am_paciente' value="<?php echo e($pacientes->am_paciente); ?>" required placeholder="Ej. Herrera">
...
<?php endif; ?>                                
 ...
 <div class="form-group">
                                    <label>CURP: </label>
                                    <input type="text" class="form-control" name = 'curp' value="<?php echo e($pacientes->curp); ?>" required placeholder="Ej. BADD110313HCMLNS09">
...
<label>Telefono: </label>
                                    <input type="text" class="form-control" name = 'telefono' value="<?php echo e($pacientes->telefono); ?>" required placeholder="Ej. 1234567890">
...
<?php endif; ?>                                
								 ...
								 <div class="form-group">
<label>Edad: </label>
                                    <input type="text" class="form-control" name = 'edad' value="<?php echo e($pacientes->edad); ?>" required placeholder="Ej. 23">
...
<?php endif; ?>                                
								...
								<div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name = 'fecha_nacimiento' value="<?php echo e($pacientes->fecha_nacimiento); ?>" required >
...
<div class="form-group">
 ...
 <div class="custom-control custom-radio">
                                            <input type="radio" id="customRadio1" name="sexo" class="custom-control-input" VALUE='M'<?php if($pacientes->sexo=='M'): ?> echo checked="checked"; <?php endif; ?>>
                                            <label class="custom-control-label" for="customRadio1">Masculino</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" id="customRadio2" name="sexo" class="custom-control-input" VALUE='F' <?php if($pacientes->sexo=='F'): ?> echo checked="checked"; <?php endif; ?>>
                                            <label class="custom-control-label" for="customRadio2">Femenino</label>
                                        </div>                            
								</div>		
	<div class="form-group">
                                    <label>Afiliación Seguro: </label>
                                    <input type="text" class="form-control" name = 'afiliacion_seguro' value="<?php echo e($pacientes->afiliacion_seguro); ?>" required placeholder="Ej. IMMS,ISSTE...">
...
<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'num_afiliacion' value="<?php echo e($pacientes->num_afiliacion); ?>" required placeholder="Ej. 765267">
...
<?php endif; ?>                                
 ...
 <div class="form-group">
                          ...
                          <option value = '<?php echo e($id_estado); ?>'><?php echo e($estado); ?></option>              
										<?php $__currentLoopData = $todasdemase; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<option value = '<?php echo e($id_municipio); ?>'><?php echo e($municipio); ?></option>                        
					  <?php $__currentLoopData = $todasdemasm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mun): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		...
		<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'cp' value="<?php echo e($pacientes->cp); ?>" required placeholder="Ej. 12345,54321...">
...
<?php endif; ?>                                
	...
	<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'localidad' value="<?php echo e($pacientes->localidad); ?>"" required placeholder="Ej. San Francisco,Niños Heroés...">
...
<?php endif; ?>                                
			...
			<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'tipo_vialidad' value="<?php echo e($pacientes->tipo_vialidad); ?>" required placeholder="Ej. Calle,Avenida,Boulevard...">
...
<?php endif; ?>                                
	 	...
	 	<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'nom_vialidad' value="<?php echo e($pacientes->nom_vialidad); ?>" required placeholder="Ej. Juarez,Independencia...">
...
<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'num_ext' value="<?php echo e($pacientes->num_ext); ?>" required placeholder="Ej. 1,2,3...">
...
<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'num_int' value="<?php echo e($pacientes->num_int); ?>"  placeholder="Ej. 1,2,3...">
...
<?php endif; ?>                                
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'tipo_asentamiento' value="<?php echo e($pacientes->tipo_asentamiento); ?>" required placeholder="Ej. Barrio,Colonia...">
...
<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name = 'nombre_asentamiento' value="<?php echo e($pacientes->nombre_asentamiento); ?>" required placeholder="Ej. Guadalupe,Indios Verdes...">
