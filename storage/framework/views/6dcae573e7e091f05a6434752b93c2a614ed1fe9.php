...
<?php $__env->startSection('receta'); ?>
            ...
            <div class="col-5 align-self-center">
                ...
                <center>
                    <img src="<?php echo e(asset('laravel/img/icons8-libro-de-salud-64.png')); ?>" width="100" height="100">
                    <br><br>

             <a type="button"  href="<?php echo e('altaht'); ?>" class="btn btn-primary">Crear Hoja de Triage</a>
              <center>
            ...
            $(document).ready(function() {
                $('#users').DataTable({
                    "serverSide": true,
                     processing: true,
                     bAutoWidth: false,
                    "ajax": "<?php echo e(url('api/hojatriage')); ?>",
                    "columns": [
