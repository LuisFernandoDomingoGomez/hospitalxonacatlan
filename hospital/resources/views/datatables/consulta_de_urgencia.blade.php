...
@section('receta')
           <div class="page-breadcrumb">
            ...
            <div class="col-5 align-self-center">
                ...
                <center>
                    <img src="{{asset('laravel/img/icons8-libro-de-salud-96.png')}}" width="110" height="110">
                    <br><br>

             <a type="button"  href="{{'altacu'}}" class="btn btn-primary btn-lg btn-block" style='width:280px; height:35px'>Crear Consulta De Urgencias</a>
              <center>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading"> Resultados De Consulta De Urgencias</div>
