...
@section('receta')
            ...
            <div class="col-5 align-self-center">
                ...
                <center>
                   <img src="{{asset('laravel/img/icons8-plan-de-tratamiento-96.png')}}" width="80" height="80">
                    <br><br>

             <a type="button"  href="{{'altato'}}" class="btn btn-primary">Crear T.O. 217B20000-203-08</a>
              <center>
