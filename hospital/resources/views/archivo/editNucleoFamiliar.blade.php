...
<div class="panel panel-default">
	<div class="panel-body">
		...
		<form role="form" class="form-horizontal"  id='familia' action="{{route('modfamiliar')}}" method="POST">
			{{csrf_field()}}
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<input id="ap_paciente" type="text" class="form-control" name="ap_paciente" required autofocus value="{{$pacientes->ap_paciente}}" required='true' lettersonly='true'>
					<span class="msg-error hidden" id="err_nombre"></span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<input id="am_paciente" type="text" class="form-control" name="am_paciente" required autofocus value="{{$pacientes->am_paciente}}">
					<span class="msg-error hidden" id="err_nombre"></span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<input id="nom_paciente" type="text" class="form-control" name="nom_paciente" required autofocus value="{{$pacientes->nom_paciente}}">
					<span class="msg-error hidden" id="err_nombre"></span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<input id="curp" type="text" class="form-control" name="curp" required autofocus value="{{$pacientes->curp}}">
					<span class="msg-error hidden" id="err_nombre"></span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<input id="parentesco" type="text" class="form-control" name="parentesco" required autofocus value="{{$expedientes->parentesco}}">
					<span class="msg-error hidden" id="err_nombre"></span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<input id="sexo" type="radio" name="sexo" required autofocus   value='M'@if ($pacientes->sexo=='M') echo checked="checked"; @endif>
					<label>Masculino</label>
					<br>
					<input id="sexo" type="radio" name="sexo" required autofocus value='F' @if ($pacientes->sexo=='F') echo checked="checked"; @endif>
