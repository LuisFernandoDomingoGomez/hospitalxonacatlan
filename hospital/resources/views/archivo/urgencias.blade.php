    ...
    <script>
       $(document).ready(function(){
           ...
           $('#users').DataTable({
                ...
                ajax: {
            url: '{!! route('datatable.expedientes') !!}',
            type: "GET",
...
$(document).ready(function(){
           ...
           $('#inactt').DataTable({
                ...
                ajax: {
            url: '{!! route('datatable.expedientesIna') !!}',
            type: "GET",
            data: {"_token":"{{ csrf_token() }}"}
            },
            ...
            window.oncontextmenu = function() {return false;}/*desabilita el menu tradicional */
                $("#users tbody").on("mousedown","tr", function (e) {
                    ...
                    if (e.button == 2){/*Si Presiona el clic derecho es 2 y ejecuta acciones*/
                        ...
                        $("#p_li").append().html("<a  href='http://localhost/sistema/public/altarecetas/"+numExpediente+"' style='color:#000000;'>Crear Receta</a> ");	
                    }
