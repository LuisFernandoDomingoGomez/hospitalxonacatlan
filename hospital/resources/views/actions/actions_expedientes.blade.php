<tr>
    <td><a href="<?php echo e(route('detalleexp', $id_expediente)); ?>" hidden="" class="p_lupa"><img src="<?php echo e(asset('laravel\img\show.png')); ?>">Mostrar</a></td>


                                                        
<td><a href="<?php echo e(route('modifica', $id_expediente)); ?>" hidden="" class="p_lapiz"> <img src="<?php echo e(asset('laravel\img\lapiz.png')); ?>">Modificar</a></td>

</tr>
<?php
if ($deleted_at=='') {
?>
<a data-toggle="modal" data-target="#create<?= $id_expediente ?>" style="cursor: pointer;" hidden="" class="p_bote"><img src="<?php echo e(asset('laravel\img\basura.png')); ?>"> Eliminar</a>
    ...
    <select type="text" class="form-control" name = 'causa_baja' id = 'causa_baja' >
        ...
        <option value="Baja">Baja</option>
            ...
            <div class="modal-footer">
                ...
                <a href="{{URL::action('cexpedientes@desactivaex', $id_expediente)}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <a href="{{URL::action('cexpedientes@restauraex', $id_expediente)}}">
                <button type="button" class="btn btn-primary"> Aceptar </button>
                </a>
            </div>
        </div>
