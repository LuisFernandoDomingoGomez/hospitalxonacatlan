...
class controladorexpedientes extends Controller
{
	...
	public function desactivarce($id_cit)
	{
	citas::find($id_cit)->delete();
	return redirect()->route('conexpedientes'); /*a la vista1*/
	}
...
$expedientes = expedientes::orderBy('id_expediente','asc')
      ...
      return view ("citas.altacitaconex")
...
$expedientes = expedientes::orderBy('id_expediente','asc')
		...
		return view('citas.modificar_citas_conexpedientes')
...
$expedientes = expedientes::orderBy('id_expediente','asc')
            ...
            return view('citas.result_busqueda_expediente')
...
$query=citas::select(['id_cit AS id_cit',
    ...
    public function funcion9(Request $request)
    {
...
$expedientes = expedientes::orderBy('id_expediente','asc')
    ...
    return view('citas.result_busqueda_expediente_modal')
 ...
 ->with('unidades',$unidades)
    ...
    public function funcion11(Request $request)
	{
		$id_cit = $request->id_cit;
		$fecha = $request->fecha;
		$hora = $request->hora;
