...
class controladorexpedientes2 extends Controller
{
	...
	public function desactivarce2($id_cit)
	{
	citas::find($id_cit)->delete();
	return redirect()->route('conexpedientes2'); /*a la vista1 de citas del dia*/
	}
...
$expedientes = expedientes::orderBy('id_expediente','asc')
      ...
      return view ("citas.altacitaconex2")
    ...
    public function funcion4(Request $request)
    {
		...
		$am_paciente = $request->am_paciente;
			...
			echo "<script>";
			echo "alert('$mensaje');";  
			echo "window.location = 'conexpedientes2';";
			echo "</script>"; 
...
$expedientes = expedientes::orderBy('id_expediente','asc')
		...
		return view('citas.modificar_citas_conexpedientes2')
...
$expedientes = expedientes::orderBy('id_expediente','asc')
            ...
            return view('citas.result_busqueda_expediente2')
