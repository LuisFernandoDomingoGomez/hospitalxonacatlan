...
<link rel="stylesheet" href="styles/css/bootstrap.css">
	...
	<!-- main css -->
	<link rel="stylesheet" href="<?php echo e(asset('styles/css/style.css')); ?>">
...
<body onload="startTime()">
							...
							<div class="col-lg-12 pr-0">
								<ul class="nav navbar-nav center_nav pull-right">
									<li class="nav-item active" >
										<br>
										<a class="nav-link active"  href="http://www.sistemaintegralhospitalario.com/index.html">Inicio</a>
									</li>
									<li class="nav-item active ">
										<br>
										<a class="nav-link active"  href="http://www.sistemaintegralhospitalario.com/departments.html">Información</a>
									</li>
									
									<li class="nav-item active">
										<br>
										<a class="nav-link active"  href="http://www.sistemaintegralhospitalario.com/doctors.html">Contacto</a>
									</li>
									<li class="nav-item active">
										<br>
										<a class="nav-link active"   href="http://www.sistemaintegralhospitalario.com/sistema/public/index	">Acceder</a>
									</li>
								</ul>
							</div>
						</div>
  ...
  <div class="clockdate-wrapper">
    ...
    <div id="date"></div>
		...
		<input class="input100" type="email" name="email" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" placeholder="Correo del usuario" value="<?php echo e(old('email')); ?>">
