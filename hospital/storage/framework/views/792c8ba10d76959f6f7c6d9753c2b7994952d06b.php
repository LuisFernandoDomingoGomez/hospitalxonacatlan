...
<?php $__env->startSection('receta'); ?>
        ...
        <div class="col-5 align-self-center">
                ...
                <center>
                   <img src="<?php echo e(asset('laravel/img/triage166.png')); ?>" width="110" height="110">
                    <br><br>

             <a type="button"  href="<?php echo e('altato16'); ?>" class="btn btn-primary">Crear Triage Obstetrico 217B20000-203-16</a>
              <center>
            ...
            $(document).ready(function() {
                $('#users').DataTable({
                    "serverSide": true,
                     processing: true,
                     bAutoWidth: false,
                    "ajax": "<?php echo e(url('api/triageobstetrico16')); ?>",
                    "columns": [
