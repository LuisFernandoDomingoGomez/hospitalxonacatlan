          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                 <a href="http://localhost/2/sistema/public/perfilusuario" class="btn btn-default btn-flat">Perfil</a>
                </div>
...
<li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <!--<label>Click m <input type="submit" id="Name" name="Consultardef" /></label> -->
              ...
              <li><a href="<?php echo e('conexpedientes'); ?>"><img src="<?php echo e(asset('laravel/img/historial-medico1.png')); ?>" width="20" height="20">Con expedientes</a></li>
