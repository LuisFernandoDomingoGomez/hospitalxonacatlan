...
<div class="panel panel-default">
	<div class="panel-body">
		...
		<form role="form" class="form-horizontal"  id='newfamilia' action="<?php echo e(route('nvaltafamiliar')); ?>" method="POST">
...
<input type="text" value="<?php echo e($expedientes->id_expediente); ?>" id="id_expediente" name="id_expediente" hidden>
			...
			<input type="text" value="<?php echo e($pacientes->afiliacion_seguro); ?>" id="afiliacion_seguro" name="afiliacion_seguro" hidden>
			<input type="text" value="<?php echo e($pacientes->nom_vialidad); ?>" id="nom_vialidad" name="nom_vialidad" hidden>
			<input type="text" value="<?php echo e($pacientes->tipo_vialidad); ?>" id="tipo_vialidad" name="tipo_vialidad" hidden>
			<input type="text" value="<?php echo e($pacientes->num_int); ?>" id="num_int" name="num_int" hidden>
			<input type="text" value="<?php echo e($pacientes->num_ext); ?>" id="num_ext" name="num_ext" hidden>
			<input type="text" value="<?php echo e($pacientes->nombre_asentamiento); ?>" id="nombre_asentamiento" name="nombre_asentamiento" hidden>
			<input type="text" value="<?php echo e($pacientes->tipo_asentamiento); ?>" id="tipo_asentamiento" name="tipo_asentamiento" hidden>
			<input type="text" value="<?php echo e($pacientes->cp); ?>" id="cp" name="cp" hidden>
			<input type="text" value="<?php echo e($pacientes->localidad); ?>" id="localidad" name="localidad" hidden>			
			<input type="text" value="<?php echo e($pacientes->id_municipio); ?>" id="id_municipio" name="id_municipio" hidden>
			<input type="text" value="<?php echo e($pacientes->id_estado); ?>" id="id_estado" name="id_estado" hidden>


<input type="text" value="<?php echo e($expedientes->id_unidad); ?>" id="id_unidad" name="id_unidad" hidden>
