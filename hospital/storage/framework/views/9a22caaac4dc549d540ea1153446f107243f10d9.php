    ...
    <tr>
        ...
        <tr>
            ...
            <td colspan="2" style="border: none;">
                    ...
                    <input type="text" class="form-control openBtn" size=2 name="Primario" id="Primario1" placeholder="Primario" style="cursor:pointer" onclick="muestraModal1(1)">
        ...
        <tr>
            ...
            <td style="border: none;">
                    ...
                    <font size=1>CLAVE DEL DIAGN&Oacute;STICO(CIE-10)</font><br>
                    <input type="text" class="form-control" size=2 name="Primario2" id="Primario2" placeholder="primario" style="cursor:pointer" onclick="muestraModal1(2)">
        ...
        <tr>
            ...
            <td style="border: none;">
                    <font size=1>CLAVE DEL DIAGN&Oacute;STICO(CIE-10)</font><br>
                    <input type="text" class="form-control" size=2 name="Primario3" id="Primario3" placeholder="Primario" style="cursor:pointer" onclick="muestraModal1(3)">
...
$(document).ready(function() {
    var table = $('#tablaAjax').DataTable();//Guarda en variable datatable
        $('#tablaAjax tbody').on('click', 'tr', function () {/*Agrega evento onclick a los tr de la datatable y realiza siguientes acciones:*/
            ...
            $("#Nombre_M"+numeroInput).val(texto);//Coloca a input el texto que selecciona usuario
        } );
        $('.modal-header,.modal-footer').on('click', 'button', function () {
            table.ajax.reload();
            table.search("").columns().search("").draw();
            $('#myModal').hide();
        });
...
$(document).ready(function() {
    var table1 = $('#tablaPrimario').DataTable();//Guarda en variable datatable
        $('#tablaPrimario tbody').on('click', 'tr', function () {/*Agrega evento onclick a los tr de la datatable y realiza siguientes acciones:*/
            ...
            $("#Primario"+numeroInput).val(texto);//Coloca a input el texto que selecciona usuario
        } );
        $('.modal-header,.modal-footer').on('click', 'button', function () {
            table1.ajax.reload();
            table1.search("").columns().search("").draw();
