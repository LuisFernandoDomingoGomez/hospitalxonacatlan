...
<?php $__currentLoopData = $res; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 <center> 
   ...
   <table style="border-collapse: collapse" WIDTH="1000" border="1" cellspacing="0" cellpadding="10">
        ...
        <tr>
            <td colspan="2" style="border: none;"><input type="radio" id="tipo" value="1" name="tipo" required="required" checked=ORDIN"checked">ORDINARIA</td>
    ...
    <tr>
        ...
        <tr>
            <td style="border: none;">
               ...
               <input type="text" class="form-control" size=15 name="expediente" id="" value="<?php echo e($r->expediente); ?>" placeholder="Numero expediente" readonly>
