...
<?php $__env->startSection('receta'); ?>
        ...
        <div class="col-5 align-self-center">
                ...
                <center>
                   <img src="<?php echo e(asset('laravel/img/trabajo-en-equipo.png')); ?>" width="80" height="80">
                    <br><br>

             <a type="button"  href="<?php echo e('altatra'); ?>" class="btn btn-primary">Crear Nuevo Trabajador</a>
              <center>
            ...
            $(document).ready(function() {
                $('#users').DataTable({
                    "serverSide": true,
                     processing: true,
                     bAutoWidth: false,
                    "ajax": "<?php echo e(url('api/trabajadores')); ?>",
                    "columns": [
