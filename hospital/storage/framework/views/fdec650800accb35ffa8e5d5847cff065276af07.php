...
<script type="text/javascript">
                    ...
                    <script type="text/javascript">
                        $(document).ready(function () {
                            ...
                            $("#Clave_Diagnostico2").autocomplete({
                                source: items
                            });
                        });
                    </script>
                    <script type="text/javascript">
                        $(document).ready(function () {
                            ...
                            $("#Clave_Diagnostico3").autocomplete({
                                source: items
                            });
                        });
                    </script>
...
<h3>
                            <p style="color:#000000">Ingresa expediente</p></h3>
                            <input onkeydown="javascript:tecla(event);" type="text" class="form-control" style= "width:30%;border: 2px solid; border-radius: 4px;margin:8px;padding:8px;box-sizing:border-box; "
                             id="p_buscar" name="buscar" placeholder="Buscar">   
                            <input type="button"
                             id="buscar" name="buscar" value="buscar"> 
    <br>
    <br>
<div id="resultado">
   ...
   <table style="border-collapse: collapse" WIDTH="1000" border="1" cellspacing="0" cellpadding="10">
    ...
    <tr>
            ...
            <td colspan="" style="border: none;">
                ...
                <input type="text" class="form-control" class="sinborde" size=2 name="Clave_servicio" id="" value="<?php echo e($t->jurisdiccion); ?>" placeholder="Clave" readonly>
            </td>
            
            <td colspan="3" style="border: none;">
                <br>
               <font size=1> NOMBRE Y CLAVE DE LA UNIDAD M&Eacute;DICA:</font><br><br><br>
        ...
        <td style="border: none;">
            ...
            <font size=1>
                ...
                &nbsp;&nbsp;<input type="radio" id="con_ext" name="Area"  >&nbsp;CONSULTA EXTERNA &nbsp;
                            <input type="radio" id="urgencias" name="Area" >&nbsp;URGENCIAS<br>
                &nbsp;&nbsp;<input type="radio" id="h" name="Area" >&nbsp;HOSPITALIZACI&Oacute;N
            </font>
            ...
            <!-- <td colspan="" style="border: none;"> -->
                ...
                <input type="text" class="form-control" size="20" name="Nom_servicio" id="" value="<?php echo e($t->cve_area); ?>" placeholder="Clave" required>
            </td>
            ...
            <td style="border: none;">
               ...
               <font size=1>
                ...
                <input type="radio" id="cobertura3" name="cobertura" value="3">&nbsp;OP&nbsp;
        ...
        <tr>
            ...
            <td colspan="" style="border: none;">
                <font size="1">CANTIDAD SOLICITADA</font><br>
                 <input type="text" class="form-control" name="Cantidad_solicitada"value="<?php echo e(old('Cantidad_solicitada')); ?>" placeholder="CANTIDAD SURTIDA" onkeypress="return solonumeros(event)">
