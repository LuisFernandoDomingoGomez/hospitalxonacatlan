    ...
    <tr>
        ...
        <tr>
            ...
            <td colspan="" style="border: none;">
                ...
                <input type="text" class="form-control" name="Cantidad_solicitada" id="Cantidad_solicitada" value="{{old('Cantidad_solicitada')}}" placeholder="Cantidad Solicitada" onkeypress="return solonumeros(event)"> 
