   ...
   <table style="border-collapse: collapse" WIDTH="1000" border="1" cellspacing="0" cellpadding="10">
    ...
    <tr>
            ...
            <td colspan="" style="border: none;">
                ...
                <input type="text" class="form-control" class="sinborde" size=2 name="Clave_servicio" id="" value="{{$t->jurisdiccion}}" placeholder="Clave" readonly>
            </td>
        ...
        <tr>
            ...
            <td colspan="" style="border: none;">
                <font size="1">CANTIDAD SOLICITADA</font><br>
                 <input type="text" class="form-control" name="Cantidad_solicitada"value="{{old('Cantidad_solicitada')}}" placeholder="CANTIDAD SURTIDA" onkeypress="return solonumeros(event)">
