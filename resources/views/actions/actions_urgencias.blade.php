<!--<a href="{{route('detalleexp', $id_expediente)}}"><img src="{{asset('laravel\img\system.png')}}">Ver</a>
<a href="#" class="btn btn-primary btn-sm">Editar</a> 
<a href="{{route('altacitas', $id_expediente)}}"><img src="{{asset('laravel\img\calendario-cita.png')}}">Agendar cita</a>

<a href="{{route('modifi', $id_expediente)}}"> <img src="{{asset('laravel\img\editar-archivo.png')}}">Modificacion</a>-->
