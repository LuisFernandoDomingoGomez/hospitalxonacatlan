...
<!-- ============================================================== -->
           ...
           <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Triage Obstetrico 217B20000-203-16</h4>
                    </div>
 ...
 <div class="col-md-12">						
 <a href="{{'altato16'}}"><div class="card" style="background-color: #c1c1c1;"  >
                            <div class="card-body" align='center'>
                                <h2 class="m-b-0"><i class="m-t-100 mdi mdi-arrow-up-bold-circle"></i><br>
                                <span class="label label-info label-rounded">Crear hoja de triage obstetrico</span></h2>
                            </div>
                        </div>
						</a>
                       </div>
...
<th scope="col"><i class="mdi mdi mdi-invert-colors"></i>Código</th>
<th scope="col"colspan="2" ><div align='center'><i class="mdi mdi mdi-apps"></i>Acciones</div></th>

</tr>
</thead>
@foreach($triages16_obstetricos as $to)
<tbody>
<tr>
<th class="table-active" scope="row">{{$to->Folio}}</th>
<td>{{$to->Nombre}}</td>
<td>{{$to->Apellido_P}}</td>
<td>{{$to->Apellido_M}}</td>
<td>{{$to->Fecha_Elaboracion}}</td>
@if($to->Codigo=='Rojo')
<td bgcolor="#FF3D3D"></td>
 @endif
 @if($to->Codigo=='Amarillo')
<td bgcolor="Yellow"></td>
 @endif
 @if($to->Codigo=='Verde')
<td bgcolor="#49E80D"></td>
 @endif
	@if($to->deleted_at=="")
	<td>
	<a href="{{URL::action('ctriageobstetrico16@desactivato16',['Folio'=>$to->Folio])}}"> 
	<i class="mdi mdi-arrow-down-bold-circle"></i>Desactivar	
	</a> </td>
	<td>
	<a href="{{URL::action('ctriageobstetrico16@revisato16',['Folio'=>$to->Folio])}}"> 
	<i class="mdi mdi mdi-eye"></i>Revisar </td>	
	</a> 
	@else
	 <td><a href="{{URL::action('ctriageobstetrico16@restaurato16',['Folio'=>$to->Folio])}}">
	<i class="mdi mdi mdi-file-restore"></i> Restaurar
	</a></td> 
	<td><a href="{{URL::action('ctriageobstetrico16@eliminato16',['Folio'=>$to->Folio])}}"> 
...
<div align='center'>{{ $triages16_obstetricos->links() }}</div>			
