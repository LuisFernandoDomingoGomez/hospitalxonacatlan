        ...
        <header class="topbar" data-navbarbg="skin6">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="error-body text-center">
                    <h4 class="pagle-title">Bienvenido, tu sesión esta activa: {{Session::get('sesionname')}}</h4>
                </div>
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
							...
							<img src="{{asset('archivos/'.Session::get('sesionfoto'))}}" alt="user" class="rounded-circle" width="40"></a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="{{URL::action('cusuarios@perfilusuario')}}"><i class="ti-user m-r-5 m-l-5"></i>Revisar Perfil</a>
								<a class="dropdown-item" href="{{URL::action('login@cerrarsesion')}}"><i class="ti-wallet m-r-5 m-l-5"></i>Cerrar Sesión</a>
        ...
        <div class="menu-list">
			...
			<ul id="sidebarnav" class="sidebarnav collapse out">
                ...
                <ul class="sub-menu collapse" id="Sistema">
					...
					<a href="{{URL::action('cusuarios@principal')}}" class="sidebar-link waves-effect waves-dark sidebar-link" aria-expanded="false">
                                <i class="mdi mdi mdi-account"></i>
                                <span class="hide-menu">Usuarios</span>
							</a></li>
                    <li class="sidebar-item">       
					<a href="{{URL::action('ctrabajadores@principalt')}}" class="sidebar-link waves-effect waves-dark sidebar-link" aria-expanded="false">
                                <i class="mdi mdi mdi-worker"></i>
                                <span class="hide-menu">Trabajadores</span>
                            </a></li>
							<li class="sidebar-item">       
					<a href="{{URL::action('cpacientes@principalp')}}" class="sidebar-link waves-effect waves-dark sidebar-link" aria-expanded="false">
