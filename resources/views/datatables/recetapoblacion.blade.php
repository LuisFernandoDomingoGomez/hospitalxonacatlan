...
<div class="page-breadcrumb">
            ...
            <div class="col-5 align-self-center">
             ...
             <a type="button" href="{{'recetapa'}}" class="btn btn-primary">Crear Receta Medica</a>
              <center>
                </div>
            </div>
@endsection                <!-- /# column -->
           ...
           $(document).ready(function(){
			//    alert("Ya");
               $('#users1').DataTable({
                     ...
                     bAutoWidth: false,
					ajax: {
                        url: '{!! route('datatable.recetas_medicasSin') !!}',
                type: "GET",
           ...
           $(document).ready(function(){
			//    alert("Ya");
               $('#inactt').DataTable({
                     ...
                     bAutoWidth: false,
					ajax: {
                        url: '{!! route('datatable.recetas_medicasInaSin') !!}',
                type: "GET",
                data: {"_token":"{{ csrf_token() }}"}
                },
