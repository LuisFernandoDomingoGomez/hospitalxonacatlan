...
<!-- ============================================================== -->
           ...
           <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Triage Obstetrico 217B20000-203-08</h4>
                    </div>
 ...
 <div class="col-md-12">						
 <a href="{{'altato'}}"><div class="card" style="background-color: #c1c1c1;"  >
...
@foreach($triages_obstetricos as $to)
<tbody>
<tr>
...
<td>{{$to->Fecha_Elaboracion}}</td>
	...
	@if($to->deleted_at=="")
	<td>
	<a href="{{URL::action('ctriageobstetrico@desactivato',['Folio'=>$to->Folio])}}"> 
	<i class="mdi mdi-arrow-down-bold-circle"></i>Desactivar	
	</a> </td>
	<td>
	<a href="{{URL::action('ctriageobstetrico@revisato',['Folio'=>$to->Folio])}}"> 
	<i class="mdi mdi mdi-eye"></i>Revisar </td>	
	</a> 
	@else
	 <td><a href="{{URL::action('ctriageobstetrico@restaurato',['Folio'=>$to->Folio])}}">
	<i class="mdi mdi mdi-file-restore"></i> Restaurar
	</a></td> 
	<td><a href="{{URL::action('ctriageobstetrico@eliminato',['Folio'=>$to->Folio])}}"> 
...
<div align='center'>{{ $triages_obstetricos->links() }}</div>			
