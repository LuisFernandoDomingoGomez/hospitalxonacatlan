...
<table class=MsoNormalTable border=2 cellspacing=0 cellpadding=0
 ...
 <tr style='page-break-inside:avoid'>
 		<div >
 	 <img src="{{asset('ConsultaU/img2.jpg')}}" width="840" height="77" HSPACE="5" VSPACE="0">
...
{{($consultas_urgencias->Tratamiento_realizado)}}</textarea>
 ...
 <td width=237 colspan=4 valign=top style='width:177.95pt;border-top:none;
  ...
  CAPACIDADES DIFERENTES<o:p></o:p></span></h3>
   ...
   <p class=MsoNormal> 
 <input type="text" style="WIDTH: 230px; HEIGHT:20px " class="sinborde" name="Fila2" id="Fila2"  placeholder="Escriba nombre completo:" value='{{($consultas_urgencias->Fila2)}}' >
